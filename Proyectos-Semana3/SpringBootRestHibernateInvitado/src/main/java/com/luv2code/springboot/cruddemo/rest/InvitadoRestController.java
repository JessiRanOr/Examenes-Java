...
public class InvitadoRestController {
	...
	//get en postman http://localhost:8080/api/invitados/4
	...
	//Post esta relacionado con una alta, se abre postman body/raw/JSON 
	...
	//BORRAR http://localhost:8080/api/invitados/5
